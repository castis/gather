...
bp = Blueprint("user", __name__, cli_group="user")
bp.cli.short_help = "Various user operations."


# flask user resend-password-reset castis
@bp.cli.command("resend-password-reset")
@click.argument("user")
def user_resend_password_reset(user):
